 ...
 */
public class MysqlJdbcSqlUtils extends JdbcUtils{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MysqlJdbcSqlUtils.class);
    ...
    protected Field toField(ResultSet resultSet, String tableName) {
        ...
        try {
            ...
            field.setDesc(StringUtils.defaultIfEmpty(resultSet.getString("备注"), fieldAndDescs.get(field.getFileName())));
